						...
						PlaceObj("XTemplateForEach", {
							...
							function(parent, context)
								...
								if #context.reinforcementSquads > 0 then
									table.insert(array, { name = "CALL REINFORCEMENTS", mode = "reinforcements" })
								end

								if #context.mortarSquads > 0 then
									table.insert(array, { name = "CALL MORTAR SUPPORT", mode = "mortar" })
								end
							...
							function(child, context, item, i, n, last)
								child.idRadioAction:SetText(Untranslated(context.name))
							end
						}, {
							PlaceObj("XTemplateWindow", {
								"__class",
				...
				PlaceObj("XTemplateMode", {
					...
					PlaceObj("XTemplateWindow", {
						...
						PlaceObj("XTemplateForEach", {
							...
							"run_after",
							function(child, context, item, i, n, last)
								child.idAmmo:SetText(Untranslated(context.name) .. Untranslated(" (") .. Untranslated(context.amount) .. Untranslated(")"))
							end
						}, {
							PlaceObj("XTemplateWindow", {
								"__class",
					...
					PlaceObj("XTemplateWindow", {
						...
						PlaceObj("XTemplateFunc", {
							...
							function(self, pos, button)
								...
								local lastMode = dlg.HudaRadioHistory and dlg.HudaRadioHistory[#dlg.HudaRadioHistory]
