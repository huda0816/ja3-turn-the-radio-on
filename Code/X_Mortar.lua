				...
				PlaceObj("XTemplateWindow", {
					...
					PlaceObj("XTemplateFunc", {
						...
						function(self, pos, button)
							...
							CombatActions.Bombard.bombard_shots = dlg.HudaMortarOptions and dlg.HudaMortarOptions.rounds or 1
							CombatActions.Bombard.bombard_radius = dlg.HudaMortarOptions and dlg.HudaMortarOptions.spacing or 0
